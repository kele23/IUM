...
Dalla lettura dei valori medi dei tempi impiegati nell'esecuzione del test 1 notiamo che nonostante la pratica d'uso di colori con saturazione elevata sia vivamente sconsigliata, questi rendono comunque più agevole la lettura rispetto a colori poco contrastanti con lo sfondo. L'accostamento di colori primari saturi rende sì più complesso distinguere una parola dall'altra all'interno dell'insieme disordinato, ma resta di maggiore importanza per la lettura la distinzione delle varie parole dallo sfondo.
Nel caso di migliore leggibilità il risparmio di tempo ammonta a circa il 12\%.

Tale informazione è confermata anche dai valori ottenuti sul test 2: lo sfondo blu scuro abbinato al testo chiaro riduce di oltre 1 secondo il tempo di lettura del testo rispetto alla variante con sfondo chiaro.
